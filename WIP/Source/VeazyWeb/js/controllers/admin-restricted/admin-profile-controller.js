;(function() {
	var adminProfileCtrl = function($scope, ngDialog, getUser) {
	...
	adminProfileCtrl.$inject = ['$scope', 'ngDialog', 'getUser'];
	angular.module('veazyControllers').controller('adminProfileCtrl', adminProfileCtrl);
})();